...
public class LLMController {
    ...
    public ApiResponse<String> chat(@RequestBody Map<String, String> request) {
        try {
            ...
            chatMessageService.saveMessage(userId, "user", fullPrompt, llmKey.getModelName());
            ...
            chatMessageService.saveMessage(userId, "assistant", response, llmKey.getModelName());
        ...
        try {
            ...
            streamingModel.chat(fullPrompt, new StreamingChatResponseHandler() {
                ...
                public void onCompleteResponse(ChatResponse response) {
                    try {
                        chatMessageService.saveMessage(userId, "assistant", fullResponse.toString(), modelName);
    ...
    public ApiResponse<List<ChatMessageEntity>> getChatHistory() {
        try {
            long userId = StpUtil.getLoginIdAsLong();
            List<ChatMessageEntity> history = chatMessageService.listByUserId(userId);
